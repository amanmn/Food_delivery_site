...
const { createEditShop, getMyShop, getShopByCity, getDashboardStats, deleteShop } = require('../controllers/shopController');
...
router.delete("/delete-shop", verifyToken, ownerOnly, deleteShop);
